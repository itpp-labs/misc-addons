...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        ICPSudo.set_param("odoo_backup_sh_google_disk.service_account_key", self.google_service_account_key or '')
    ...
    def get_values(self):
        ...
        ICPSudo = self.env['ir.config_parameter'].sudo()
        google_service_account_key = ICPSudo.get_param("odoo_backup_sh_google_disk.service_account_key")
