...
class ResConfigSettings(models.TransientModel):
    ...
    dropbox_folder_path = fields.Char(
        ...
        help="The Full Path to upload a Backup. E.g. /ProductionBackups",
    )
    ...
    def set_values(self):
        ...
        ICPSudo.set_param(
            "odoo_backup_sh_dropbox.dropbox_folder_path", self.dropbox_folder_path or ""
        )
    ...
    def get_values(self):
        ...
        ICPSudo = self.env["ir.config_parameter"].sudo()
        dropbox_access_token = ICPSudo.get_param(
            "odoo_backup_sh_dropbox.dropbox_access_token"
        )
        dropbox_folder_path = ICPSudo.get_param(
