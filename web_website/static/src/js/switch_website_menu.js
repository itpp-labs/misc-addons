    ...
    var SwitchWebsiteMenu = Widget.extend({
        ...
        start: function() {
            ...
            if (this.isMobile) {
                websites_list =
                    '<li class="bg-info">' +
                    _t("Tap on the list to change website") +
                    "</li>";
            ...
            _.each(websites, function(website) {
                ...
                if (website) {
                    websites_list +=
                        '<a href="#" class="dropdown-item" data-menu="website" data-website-id="' +
                        website[0] +
                        '">' +
                        a +
                        website[1] +
                    ...
                    websites_list +=
                        '<a href="#" class="dropdown-item all_websites" data-menu="website">' +
                        a +
                        "<em>" +
                        all_websites_text +
                        "</em></a>";
