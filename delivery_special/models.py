...
class DeliveryGridLine(models.Model):
    ...
    type = (
        fields.Selection(
            [
                ("weight", "Weight"),
                ("volume", "Volume")("wv", "Weight * Volume"),
                ("price", "Price"),
                ("quantity", "Quantity"),
...
class ProductTemplate(models.Model):
    ...
    special_delivery = fields.Integer(
        "Special Delivery",
        help="Allows make special rules at delivery grid. Can be negative",
    )

    _defaults = {"special_delivery": 0}
