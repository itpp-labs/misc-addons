...
class ProductCategory(models.Model):
    ...
    taxes_id = fields.Many2many(
        ...
        help="When you set the product category for your product, this taxes will be copied to the product customer taxes."
    )
    supplier_taxes_id = fields.Many2many(
        ...
        help="When you set the product category for your product, this taxes will be copied to the product vendor taxes."
    )
