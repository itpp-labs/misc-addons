...
class fleet_vehicle(osv.osv):
    ...
    def _get_odometer(self, cr, uid, ids, odometer_id, arg, context):
        res = super(fleet_vehicle, self)._get_odometer(cr, uid, ids, odometer_id, arg, context)
        return res

    def _set_odometer(self, cr, uid, id, name, value, args=None, context=None):
        res = super(fleet_vehicle, self)._set_odometer(cr, uid, id, name, value, args, context)
        return res
